...
const EntradaTabelaSDT tabela_sdt_entradas[] = {
    ...
    {"ALLOCEXPR'->TYPE",
     {{SIMBOLO, .simbolo = "VARDECL"},
      ...
      {SIMBOLO, .simbolo = "CLOSE_BRACKET"},
      {SIMBOLO, .simbolo = "ALLOCAUX"},
      {ACAO, .acao = EXPA_imprimir_expressao2}},
     6},
    ...
    {"ATRIB'->EXPRESSION",
     ...
     2},
    {"ATRIB'->FUNCCALL",
     {{ACAO, .acao = CODIGO_obter_valor_retorno}, {SIMBOLO, .simbolo = "FUNCCALL"}},
     2},
    {"ATRIBSTAT->IDENT",
    ...
    {"EXPR'->RELOP",
     {{SIMBOLO, .simbolo = "RELOP"},
      {SIMBOLO, .simbolo = "NUMEXPRESSION"},
      {ACAO, .acao = EXPA_imprimir_expressao1},
      {ACAO, .acao = CODIGO_relop_action}},
     4},
    {"EXPR->NUMEXPR",
     {{SIMBOLO, .simbolo = "NUMEXPRESSION"},
      {ACAO, .acao = EXPA_imprimir_expressao0_h},
      {SIMBOLO, .simbolo = "EXPRESSION'"},
      {ACAO, .acao = EXPA_imprimir_expressao0}},
     4},
    ...
    {"FACTOR->CONST_STRC",
     {{SIMBOLO, .simbolo = "STRC"}, {ACAO, .acao = EXPA_lexema_para_valor}},
     2},
