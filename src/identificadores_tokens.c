...
static TransicaoEstado transicoes_ident[] = {{"0", estado_ident_0}, {"1", estado_ident_1}};
...
static TransicaoEstado transicoes_inteiro[] = {{"0", estado_inteiro_0},
                                               {"1", estado_inteiro_1},
                                               {"2", estado_inteiro_2},
                                               {"3", estado_inteiro_3},
                                               {"4", estado_inteiro_4}};
...
static TransicaoEstado transicoes_float[] = {
    {"0", estado_float_0}, {"1", estado_float_1}, {"2", estado_float_2}, {"3", estado_float_3},
    {"4", estado_float_4}, {"5", estado_float_5}, {"6", estado_float_6}, {"7", estado_float_7}};
...
static TransicaoEstado transicoes_mathop[] = {{"0", estado_mathop_0}};
...
static TransicaoEstado transicoes_relop[] = {
    {"0", estado_relop_0}, {"1", estado_relop_1}, {"2", estado_relop_2}};
...
IdentificadorToken identTokenIdentifier = {"IDENT", &maquina_ident};

IdentificadorToken integerTokenIdentifier = {"NI", &maquina_inteiro};

IdentificadorToken floatTokenIdentifier = {"NPF", &maquina_float};

IdentificadorToken mathOperatorTokenIdentifier = {"MATHOP", &maquina_mathop};

IdentificadorToken oneCharTokenIdentifier = {"ONECHAR", &maquina_onechar};

IdentificadorToken stringConstCharTokenIdentifier = {"STRC", &maquina_strc};

IdentificadorToken relopTokenIdentifier = {"RELOP", &maquina_relop};