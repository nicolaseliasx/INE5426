...
bool eh_letra(char c) { return isalpha((unsigned char)c) || c == '_'; }

// Verifica se um caractere é um dígito
bool eh_digito(char c) { return isdigit((unsigned char)c); }

// Verifica se um caractere é espaço em branco
bool eh_espaco_branco(char c) { return isspace((unsigned char)c); }